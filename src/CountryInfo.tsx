...
const CountryInfo: React.FC<{ country: Country }> = ({ country }) => {
  ...
  return (
    <div className="country-info" >
      ...
      <img  data-testid="img"src={country.flags.png} alt={`Flag of ${country.capital}`} width="100px" height={'100px'} style={{marginBottom:'30px'}}/>
      <button onClick={handleCapitalWeather} id="capital" >Capital Weather</button>
      {weather && (
